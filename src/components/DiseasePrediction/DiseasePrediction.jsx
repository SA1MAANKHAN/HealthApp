...
import Disease from "./sub-components/Disease";
    ...
    <div className={classes.main}>
      <AppBar className={classes.appbar}>
        <div className={classes.dis}>
          Disease Detector
          <FaStethoscope style={{ height:"5vh", paddingLeft: "1rem" }} />
        </div>
      ...
      <div className={classes.text}>
        <Typography variant="h2" style={{ fontSize: "calc(1.5vh + 1.5vw)",fontWeight:"800"}}>
          Detect Your Disease Here !
        </Typography>
      </div>
      <div className={classes.description}  style={{ fontSize: "calc(1vh + 1vw)",fontWeight:"500"}}>
